...
def render_html_merged_dashboard(raw_df):
    ...
    <style>
        ...
        .merged-table td { padding: 8px; border: 1px solid #E2E8F0; vertical-align: middle; text-align: center; background-color: #FFFFFF; color: #333333; }
    ...
    for _, row in df.iterrows():
        html += "<tr>"  # <-- FIXED: Structural HTML bracket syntax corrected
        order_name = row.get("Name")
